          ...
          [
            {
              ...
              "extract": true,
              "stripComponents": 1,
              "targetDir": "~/.slashbot/tools/sherpa-onnx-tts/runtime",
            ...
            },
            {
              ...
              "archive": "tar.bz2",
              "extract": true,
              "targetDir": "~/.slashbot/tools/sherpa-onnx-tts/models",
...
1. Download the runtime for your OS (extracts into `~/.slashbot/tools/sherpa-onnx-tts/runtime`)
2. Download a voice model (extracts into `~/.slashbot/tools/sherpa-onnx-tts/models`)

Update `~/.slashbot/slashbot.json`:
...
```json5
{
  skills: {
    entries: {
      "sherpa-onnx-tts": {
        env: {
          SHERPA_ONNX_RUNTIME_DIR: "~/.slashbot/tools/sherpa-onnx-tts/runtime",
          SHERPA_ONNX_MODEL_DIR: "~/.slashbot/tools/sherpa-onnx-tts/models/vits-piper-en_US-lessac-high",
        },
      },
    },
  },
