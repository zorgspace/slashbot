  ...
  return [
    ...
    },
    {
      ...
      parameters: z.object({
        ...
        context_before: z.number().optional().describe('Lines of context before matches'),
        context_after: z.number().optional().describe('Lines of context after matches'),
        case_insensitive: z.boolean().optional().describe('Case insensitive search'),
        line_numbers: z.boolean().optional().describe('Include line numbers in output'),
      ...
      toAction: args => ({
        ...
        lineNumbers: args.line_numbers as boolean | undefined,
